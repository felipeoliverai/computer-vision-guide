...
Original file is located at
    https://colab.research.google.com/drive/1FVGS9clncp3K_LDmNzqQqjbSdNQWLYjZ
...
changings in images applying diff absolute between images, and visualize the differences
